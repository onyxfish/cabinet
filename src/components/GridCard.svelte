    ...
    {#if hasImage}
        <img
            ...
            style="transform: {hovered
                ? 'scale(1.02)'
                : 'scale(1)'}; transition: transform 0.5s cubic-bezier(0.25,0,0,1);"
            loading="lazy"
        />
    {:else}
        ...
        <div class="ph-label">
            <div
                class="ph-title"
                style="color: {hovered ? '#f0ebe3' : 'var(--text-dim)'}"
            >
                {displayTitle}
            </div>
            <div
                ...
                style="color: {hovered
                    ...
                    : 'var(--text-faint)'}"
            >
                <span class="uc">{work.artist}</span>{#if work.yearCreated}
                    &nbsp;· <span class="nowrap">{work.yearCreated}</span>{/if}
            </div>
        </div>
    {/if}
